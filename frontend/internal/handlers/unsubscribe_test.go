...
func (f *unsubscribeFakeBackend) GetSleepInsights(context.Context, int) (backendclient.SleepInsights, error) {
	return backendclient.SleepInsights{}, errors.New("not implemented")
}

func (f *unsubscribeFakeBackend) GetGrowthInsights(context.Context, string, int) (backendclient.GrowthInsights, error) {
...
func (f *unsubscribeFakeBackend) GetFeedInsights(context.Context, int) (backendclient.FeedInsights, error) {
	return backendclient.FeedInsights{}, errors.New("not implemented")
}

func (f *unsubscribeFakeBackend) GetPumpInsights(context.Context, int) (backendclient.PumpInsights, error) {
